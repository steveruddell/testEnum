...
#Region "Datarow Result Fields"
	...
	Public Enum eCategoryFields As Integer
		id = 0
		SiteID = 1
		legacyCategoryID = 2
		CategoryTypeID = 3
	...
	Public Enum eSectionFields As Integer
		...
		BookID = 16
		Freeview = 15
		ArticleID = 16 'The stored procedure PROC_SectionGetByArticle returns articleid at 15th position, and we don't know where bookid is being used, so to make things work we are making bookid and articleid the same position.
		quizID = 16	 'The stored procedure PROC_SectionGetByQuiz returns quizid at 15th position
		PartID = 17
	...
	Public Enum eArticleFields
		...
		startPage = 29
		endPage = 30
		relevancy = 31 '' only used in the context of categories. so always keep this at the bottom
	End Enum
...
#Region "Object Type Enums"
    ...
    Public Enum eUserRole As Integer
        NonAuthenticatedUser = 1
        InstitutionalAnonymous = 2
        InstitutionalSubUser = 3
        InstitutionalAdministrator = 4
        IndividualUser = 5
        CMEUser = 6
        SuperUser = 7
        SiteAdministrator = 8
        ContentProductionManager = 9
        MarketingManager = 10
        SubscriptionManager = 11
        ReportingManager = 12
        ContentPreviewer = 13
        UnderDevelopmentFeatureUser = 14
    End Enum
    ...
    Public Enum ePermission As Integer
        AccessToArticles = 1
        AccessToOtherContentTypesBehindSecurity = 2
        CME = 3
        CommentOnArticles = 4
        EmailAlerts = 5
        SaveContent = 6
        SeeComments = 7
        UserManagement = 8
        ProductionManagement = 9
        SiteEditingLayout = 10
        Marketing = 11
        SUMO = 12
        StatsMaster = 13
        DataSupplements = 14
        ...
        PDFDownload = 17
        PrintableView = 18
        ReprintsPermissions = 19
        ShareToSocialNetwork = 20
        SubmitComment = 21
        SubmitLetter = 22
        VideoSupplements = 23
        InstitutionCounterReport = 24
        ViewUnpublishedContent = 25
        ViewFeaturesUnderDevelopment = 26
        Slideset = 27
    End Enum
    ...
    Public Enum eInstitutionFederationFields
        ID = 0
        FederationName = 1
        ClientID = 2
        FederationTypeID = 3
